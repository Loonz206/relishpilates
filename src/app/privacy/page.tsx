...
import { getPrivacyPageContent } from "@/lib/cms";
import Card from "@/components/Card";

export async function generateMetadata(): Promise<Metadata> {
  const privacyPage = await getPrivacyPageContent();

  return {
    title: privacyPage.metadataTitle,
    description: privacyPage.metadataDescription,
  };
}
