...
import type { AboutSectionContent } from "@/lib/cms";
...
export default function AboutSection({
  content = defaultContent.homePage.about,
}: AboutSectionProps) {
  return (
    <section className="relative w-full pb-16 lg:pb-20" aria-labelledby="about-heading">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
        ...
        <div className="relative overflow-hidden bg-relish-main rounded-tl-[300px] rounded-br-[300px] rounded-tr-sm rounded-bl-sm flex flex-col gap-6 items-center text-center py-12 text-light w-full">
          ...
          <div className="font-nunito font-light text-light text-lg leading-7 max-w-[540px]">
