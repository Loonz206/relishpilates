...
import type { StepsSectionContent } from "@/lib/cms";
...
export default function StepsSection({
  content = defaultContent.homePage.steps,
}: StepsSectionProps) {
  return (
    <section
      id="schedule"
    ...
    >
      <div className="relative max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 px-6 lg:px-10 pt-10 lg:pt-12">
        {/* Decorative drips */}
        <div className="pointer-events-none absolute left-8 top-0 lg:left-12" aria-hidden="true">
          <svg
            width="182"
            height="120"
            viewBox="0 0 182 120"
        ...
        {/* CTA */}
        <Button href={content.cta.href} className="lg:col-span-12 justify-self-center">
          {content.cta.label}
        </Button>
      </div>
    </section>
